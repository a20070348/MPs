...
% edges = [0 0.3:2.5:7:15:35:70 175];
edges = [0 0.3 2.5 7 15 35 70];

figure (1)
hfl=histogram(Dzenderfl,edges,'FaceColor','g');
ylim([0 1000])
set(gca,'FontSize',24);
title(' Histogram of Fiber Equivalent Spherical Diameter','fontsize',18)
xlabel('${D_e (\mu m)}$','fontsize',36,'Interpreter','latex') 
ylabel('count','fontsize',36,'Interpreter','latex')
legend({'flat fiber'},'Location','northeast','fontsize',18)

figure (2)
hcy=histogram(Dzendercy,edges);
ylim([0 1000])
set(gca,'FontSize',24);
title(' Histogram of Fiber Equivalent Spherical Diameter','fontsize',18)
xlabel('${D_e (\mu m)}$','fontsize',36,'Interpreter','latex') 
ylabel('count','fontsize',36,'Interpreter','latex')
legend('off')
legend({'cylindrical fiber'},'Location','northeast','fontsize',18)
