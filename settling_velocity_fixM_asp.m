...
legend({'$D=10 \mu m$ surrounded by turbulence with high dissipation rate','$D=10 \mu m$ surrounded by turbulence with intermediate dissipation rate','$D=10 \mu m$ surrounded by turbulence with low dissipation rate','$D=20 \mu m$ surrounded by turbulence with high dissipation rate','$D=20 \mu m$ surrounded by turbulence with intermediate dissipation rate','$D=20 \mu m$ surrounded by turbulence with low dissipation rate'},'Location','northwest','fontsize',24,'Interpreter','latex')